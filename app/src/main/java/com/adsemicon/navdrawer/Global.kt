package com.adsemicon.navdrawer

import android.bluetooth.BluetoothAdapter
import android.bluetooth.BluetoothDevice
import android.bluetooth.BluetoothSocket
import android.content.Context
import com.adsemicon.navdrawer.function.log.MonitoringLog
import com.adsemicon.navdrawer.function.log.SystemLog
import com.adsemicon.navdrawer.monitor.Monitoring
import com.adsemicon.navdrawer.packet.RPacket
import com.adsemicon.navdrawer.register.RegisterController
...
//        val monitoring = Monitoring()   // Touch/Percent Log 객체 생성 이후에 생성
        ...
        fun initLogAndMonitoring(context: Context) {
            // Context
            com.adsemicon.navdrawer.Global.Companion.contextMain = context

            // System Logs
            com.adsemicon.navdrawer.Global.Companion.packetLog = SystemLog(context, "system", "packet.txt")
            com.adsemicon.navdrawer.Global.Companion.errLog = SystemLog(context, "system", "error.txt", "ERR", true)

            // Monitoring Logs
            com.adsemicon.navdrawer.Global.Companion.touchLog = MonitoringLog(context, "monitoring", "touch.txt")
            com.adsemicon.navdrawer.Global.Companion.percentLog = MonitoringLog(context, "monitoring", "percent.txt")

            // Monitoring
            com.adsemicon.navdrawer.Global.Companion.monitoring = Monitoring()   // Touch/Percent Log 객체 생성 이후에 생성
        }
    }
}