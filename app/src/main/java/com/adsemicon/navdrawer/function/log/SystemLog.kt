package com.adsemicon.navdrawer.function.log

import android.content.Context
import android.util.Log
import com.adsemicon.navdrawer.Global
import com.adsemicon.navdrawer.function.LogParent
    ...
    fun printPacket(type: PacketType, str: String) {
        if (isEnabled) {
            ...
            try {
                ...
                createFile(com.adsemicon.navdrawer.Global.contextMain, this.folderName, this.fileName)
