package com.adsemicon.navdrawer.packet
...
class Packet {
    companion object {
        ...
        val packetCategory = mapOf(
            "E" to com.adsemicon.navdrawer.PacketCategory.Rom,
            "M" to com.adsemicon.navdrawer.PacketCategory.Monitoring,
            "R" to com.adsemicon.navdrawer.PacketCategory.Register,
            "H" to com.adsemicon.navdrawer.PacketCategory.Hardware,
            "T" to com.adsemicon.navdrawer.PacketCategory.Test
        )

        val packetKind = mapOf(
            "HW" to com.adsemicon.navdrawer.PacketKind.HwWrite,
            "HR" to com.adsemicon.navdrawer.PacketKind.HwRead,

            "MS" to com.adsemicon.navdrawer.PacketKind.MonSet,
            "MT" to com.adsemicon.navdrawer.PacketKind.MonTouch,
            "MP" to com.adsemicon.navdrawer.PacketKind.MonPercent,

            "RX" to com.adsemicon.navdrawer.PacketKind.RegSingleRead,
            "RY" to com.adsemicon.navdrawer.PacketKind.RegSingleWrite,
            "RI" to com.adsemicon.navdrawer.PacketKind.RegSwReset
        )

        private val listTxPacket: ArrayList<Byte> = ArrayList()

        private fun setHeader(kind: com.adsemicon.navdrawer.PacketKind) {
        ...
        // 데이터 없는 Packet 생성/전송
        //--------------------------------------------------------------------------------------//
        fun send(os: OutputStream?, kind: com.adsemicon.navdrawer.PacketKind) {
            listTxPacket.clear()
        ...
        //--------------------------------------------------------------------------------------//
        fun send(os: OutputStream?, kind: com.adsemicon.navdrawer.PacketKind, b: Byte) {
            listTxPacket.clear()
        ...
        //--------------------------------------------------------------------------------------//
        fun send(os: OutputStream?, kind: com.adsemicon.navdrawer.PacketKind, ba: ByteArray) {
            listTxPacket.clear()
        ...
        //--------------------------------------------------------------------------------------//
        fun send(os: OutputStream?, kind: com.adsemicon.navdrawer.PacketKind, ba: ByteArray, dataLength:Int) {
            var i: Int
            listTxPacket.clear()
        ...
        private fun logTxPacket(ba: ByteArray) {
            ...
            com.adsemicon.navdrawer.Global.packetLog.printPacket(PacketType.TX, logStr.toString())  // 임시, 향 후 Library 적용 예정
