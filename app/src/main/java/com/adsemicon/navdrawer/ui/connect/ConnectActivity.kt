...
import com.adsemicon.navdrawer.databinding.ActivityConnectBinding
...
class ConnectActivity : AppCompatActivity() {
    ...
    private val listenerItemClick =  AdapterView.OnItemClickListener { parent, view, position, id ->
        com.adsemicon.navdrawer.Global.selectedDevice = mmDevices[position]
    ...
    private fun getPairedDevices() {
        ...
        val pairedDevices = com.adsemicon.navdrawer.Global.adapter.bondedDevices
