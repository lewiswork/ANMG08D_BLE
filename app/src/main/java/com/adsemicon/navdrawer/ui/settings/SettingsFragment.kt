package com.adsemicon.navdrawer.ui.settings
...
import com.adsemicon.navdrawer.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    private fun setControlStatus() {
        binding.swSysLog.isChecked = com.adsemicon.navdrawer.Global.packetLog.isEnabled
        binding.swMonLog.isChecked = com.adsemicon.navdrawer.Global.touchLog.isEnabled && com.adsemicon.navdrawer.Global.percentLog.isEnabled
    }
    ...
    private val listenerSwitches = View.OnClickListener {
        try {
            ...
            when (it) {
                binding.swSysLog -> {
                    com.adsemicon.navdrawer.Global.packetLog.isEnabled = binding.swSysLog.isChecked
                ...
                binding.swMonLog -> {
                    com.adsemicon.navdrawer.Global.touchLog.isEnabled = binding.swMonLog.isChecked
                    com.adsemicon.navdrawer.Global.percentLog.isEnabled = binding.swMonLog.isChecked
